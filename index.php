...
<body>
        ...
        <div class="container">
          <div class="card">
            <div class="card-body">
              ...
              <h5 style="text-align:center;" class="card-title fw-semibold mb-4"> Total number of user</h5>
               <?php 

                $query = " SELECT `id` FROM `user_form` WHERE `user_type`='user' ";
                $query_run = mysqli_query($conn,$query);
                $rows = mysqli_num_rows($query_run);
                echo '<h1 style="text-align:center;"> '.$rows.'</h1>';
                ?>
            </div>
          </div>
        </div>
 ...
 <p style="text-align: center; font-family: 'Dancing Script', cursive; margin-left: 190px;">@2023 All right reserved</p>
