...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
                  <h5 class="card-title fw-semibold mb-4">Address</h5>
                                  ...
                                  foreach($query_run as $row){
                                    ?>
                                      <tr>
                                        ...
                                        <td><?=  $row['province']; ?></td>
                                        <td><?=  $row['district']; ?></td>
                                        <td><?=  $row['village_nagar']; ?></td>
                                        <td><?=  $row['wada_no']; ?></td>

                                        <td>
                                          <form method="POST" action="addresss_del.php">
    ...
    <p style="text-align: center; font-family: 'Dancing Script', cursive; margin-left: 50px;">@2023 All right reserved</p>
  </div>
