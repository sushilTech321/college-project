    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
                  <h5 class="card-title fw-semibold mb-4">Details of user</h5>
                                  ...
                                  foreach($query_run as $row){
                                    ?>
                                      <tr>
                                        ...
                                        <td>
                                          <form method="POST" action="userdetails_del.php">
     ...
     <p style="text-align: center; font-family: 'Dancing Script', cursive; margin-left: 100px;">@2023 All right reserved</p>
  </div>
