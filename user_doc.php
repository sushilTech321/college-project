    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Document numbers</h5>
              <table class="table table-bordered table-hover">
                <thead>
                  <tr>
                    <th scope="col">id</th>
                    <th scope="col">Birth certificate no</th>
                    <th scope="col">Father citizenship no</th>
                ...
                <tbody>
                   <?php 
                              ...
                              $query = "SELECT * FROM `user_document` ";
                                  ...
                                  foreach($query_run as $row){
                                    ?>
                                      <tr>
                                        ...
                                        <td><?=  $row['f_citizenship_no']; ?></td>

                                        <td>
                                          <form method="POST" action="userdoc_del.php">
